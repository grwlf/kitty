...
let g:terminal_images_min_columns = get(g:, 'terminal_images_min_columns', 1)
let g:terminal_images_min_rows = get(g:, 'terminal_images_min_rows', 1)
...
let g:terminal_images_columns_per_inch = get(g:, 'terminal_images_columns_per_inch', 6.0)
let g:terminal_images_rows_per_inch = get(g:, 'terminal_images_rows_per_inch', 3.0)
...
function! UploadTerminalImage(filename, cols, rows)
    ...
    " properties.
    let command = s:path . "/../upload-terminal-image.sh" .
                \ " -c " . cols_str .
                \ " -r " . rows_str .
